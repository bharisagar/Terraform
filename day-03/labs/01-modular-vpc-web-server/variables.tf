variable "aws_region" {
  description = "AWS region for the Day 3 modular lab."
  type        = string
  default     = "ap-south-1"
...
variable "instance_type" {
  ...
  validation {
    ...
    error_message = "Use one of these Day 3 lab instance types: t2.micro, t3.micro, t3.small."
  }
}
